...
export interface TranslationKeys {
  ...
  signCredits: string;
  signFailed: string;
  removeBgKeyLabel: string;
  removeBgKeyHint: string;
  ...
  aiVoiceKeyLabel: string;
  aiVoiceKeyHint: string;
  aiSetupTitle: string;
  aiSetupBody: string;
  ...
  aiKeyLabel: string;
  aiKeyHint: string;
  aiGatewayUrlLabel: string;
  aiGatewayUrlHint: string;
  aiTestLabel: string;
  aiTestOk: string;
  aiVoiceHint: string;
  aiAccept: string;
  ...
  settingsRemindersSub: string;
  settingsHomeSub: string;
  settingsMoneySub: string;
  settingsDocsSub: string;
  ...
  remDailyDesc: string;
  remDeadlineDesc: string;
  remUdhaarDesc: string;
  remBuyerDesc: string;
  homeSectionDesc: string;
  devToolsHint: string;
  companyDetailsSub: string;
  aiUsageIn: string;
  aiUsageOut: string;
  aiUsageCached: string;
